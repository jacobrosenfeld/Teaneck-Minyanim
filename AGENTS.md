...
- If a commit is a direct follow-up fix for a bug introduced in the same unreleased change set, do **not** bump the version again; keep updating the existing `[Unreleased]` entry.
