...
### Fixed
- **XLSX Selichos override imports (#263)**: Manual override XLSX templates now include standalone `SELICHOS`, org/super-admin imports accept Selichos rows including full-day replacement days, and wrong-template uploads now fail fast with a clear page-specific error.
