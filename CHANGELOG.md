...
- **Invisible reCAPTCHA protection**: Added External Services settings for reCAPTCHA site/secret keys and server-side verification for public feedback and newsletter subscription submissions.
