...
### Fixed
- **XLSX Selichos override imports (#263)**: Manual override XLSX templates now include standalone `SELICHOS`, and org/super-admin imports accept Selichos rows including full-day replacement days.
