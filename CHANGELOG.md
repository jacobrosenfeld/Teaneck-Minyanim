...
- **Passkey registration page (#243)**: Replaced Spring Security's generated passkey registration page with an app-styled page to avoid a CSRF-disabled 500 and to keep passkey setup inside the admin design system.
