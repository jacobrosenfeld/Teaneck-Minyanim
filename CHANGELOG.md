...
### Fixed
- **XLSX Selichos override imports (#263)**: Manual override XLSX templates now include Selichos-compatible minyan types, and org/super-admin imports are covered for successful `SELICHOS` rows including full-day replacement days.
