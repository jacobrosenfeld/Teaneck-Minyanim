...
const Colors = {
  light: {
    ...
    badge: {
      ...
      SELICHOS_SHACHARIS: { bg: '#EBF2FF', text: '#1A4FAD' },
      NIGHT_SELICHOS: { bg: '#E9F8EF', text: '#166534' },
  ...
  dark: {
    ...
    badge: {
      ...
      SELICHOS_SHACHARIS: { bg: '#162040', text: '#93B8FF' },
      NIGHT_SELICHOS: { bg: '#0F2D1B', text: '#86EFAC' },
